The objectif behind this project is to apply the K-means machine learning method on our bristol bike data, in order to group bikes according to their locations.
